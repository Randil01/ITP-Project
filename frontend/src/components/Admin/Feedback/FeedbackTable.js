...
const FeedbackTable = ({ rows, deleteFeedback }) => {
    ...
    const handleGeneratePDF = () => {
        ...
        img.onload = function () {
            ...
            // Add the company name and report heading centered
            doc.setFontSize(22);
            doc.setFont('bold');
